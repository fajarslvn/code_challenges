...
Note: The switch statement could have also been an else if statement. 
*/
...
- The variable regex is a regular expression 1.1k representing values (letters) for the higher cards.
